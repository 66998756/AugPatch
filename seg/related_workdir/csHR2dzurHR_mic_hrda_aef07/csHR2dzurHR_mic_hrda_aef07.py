...
model = dict(
    ...
    train_cfg=dict(
        work_dir=
        'work_dirs/euler-exp67/221101_2054_csHR2dzurHR_1024x1024_dacs_a999_fdthings_rcs001-20_m64-07-sep_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_w1_s0_aef07',
        log_config=dict(
            interval=50,
            img_interval=1000,
            hooks=[dict(type='TextLoggerHook', by_epoch=False)])),
...
name = '221101_2054_csHR2dzurHR_1024x1024_dacs_a999_fdthings_rcs001-20_m64-07-sep_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_w1_s0_aef07'
exp = 67
...
work_dir = 'work_dirs/euler-exp67/221101_2054_csHR2dzurHR_1024x1024_dacs_a999_fdthings_rcs001-20_m64-07-sep_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_w1_s0_aef07'
